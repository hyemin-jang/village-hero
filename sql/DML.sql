...
insert into errand values(errand_seq.nextval, 3, '2021-10-13', '급하게 서류 전달해 주실 분!?', '급한 건데 몸이 아파서 대신 전달해 주실 분 계실까요~', '배달', '마포', '2021-10-13', 3);

-- errand apply[심부름 지원 저장]
insert into apply values(apply_seq.nextval, 1, '파주지역 이거저거 배달 가능합니다! 불러주세요~');
insert into apply values(apply_seq.nextval, 2, '청소 및 모든 집안일 겁나 잘합니다ㅎㅎ');
insert into apply values(apply_seq.nextval, 3, '마당있는 전원주택입니다^^반려친구들과 편하게 방문하세요^^');

-- errand errrand_apply[관계를 위한 테이블]
