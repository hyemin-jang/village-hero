...
-- [심부름 등록]
insert into errand values(errand_seq.nextval, 1, '2021-10-11', '바퀴벌레 잡아 주실 분ㅠㅠ', '집에 바퀴벌레가 너무 많아요ㅠㅠ 처리 가능한 용자분 찾습니다!', '벌레/쥐잡기', '서울시 강서구 등촌로 223', '2021-10-11', 5000, '3', '2021-10-12');
...
insert into errand values(errand_seq.nextval, 3, '2021-10-13', '급하게 서류 전달해 주실 분!?', '급한 건데 몸이 아파서 대신 전달해 주실 분 계실까요~', '배달/장보기', '서울시 강서구 등촌로39가길 15-6', '2021-10-13', 15000, '1', NULL);
...
insert into errand values(errand_seq.nextval, 3, '2021-10-15', '1일 남친 구해요', '친구 결혼식에 전남친이 올텐데 남친대행 구합니다.', '역할대행', '경기도 파주시 다율동 해올로 20 146-5', '2021-10-24', 50000, '0', NULL);
